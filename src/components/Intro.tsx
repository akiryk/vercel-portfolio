...
const Intro = () => {
  return (
    <>
      ...
      >
        <Text>
          I&rsquo;m a front-end engineer with over twelve years&rsquo;
          experience in the industry, first as a UX and UI designer, then as a
          developer. I&rsquo;m passionate about performance, stability, and
